...
class PubOrderActivity : BaseActivity() {
    ...
    private fun initListener() {
        renterDayPicker = OnePicker(this, (0..15).mapTo(arrayListOf <String>()) {
            if (it == 0) {
                "半天"
            } else {
                "" + it + "天"
        ...
        datePicker = OnePicker(this, (1..7).mapTo(arrayListOf()) { TextUtil.getFormatString(System.currentTimeMillis() + it * 24 * 3600 * 1000, "yyyy年MM月dd日") })
