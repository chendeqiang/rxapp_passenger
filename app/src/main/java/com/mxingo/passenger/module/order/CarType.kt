 ...
 */
enum class CarType {
    ECONOMIC(1, "经济型", 4), COMFORT(2, "舒适型", 4), BUSINESS(3, "商务型", 6), BUICK(911, "别克GL8", 7), DELUXE_CAR(5, "豪华型", 4), LUXURY(4, "奢华型", 4),
    DELUXE_BUSINESS(18, "豪华商务型", 4), EIGHT_MINIBUSES(20, "8座小巴", 8), TEN_MINIBUSES(14, "10座小巴", 10), FIFTEEN_MINIBUSES(21, "15座中巴", 15),
    TWENTY_BUSINESS(15, "20座中巴", 20), TWENTY_FIVE_BUSINESS(23,"25座中巴", 25), THIRTY_FIVE_BUSINESS(16, "35座大巴", 35), FORTY_BUSINESS(24, "40座大巴", 40), FORTY_FIVE_BUSINESS(17, "45座大巴", 45),
